...
const codeLines = [
  { text: 'import { ChatBot } from "@pratham/chatbot";', color: "#7a8aaa" },
  ...
  { text: "", color: "transparent" },
  { text: '      <ChatBot apiEndpoint="https://your-server.com" />', color: "#00e5a0", highlight: true },
  { text: "    </div>", color: "#7a8aaa" },
  { text: "  );", color: "#d0daf0" },
  { text: "}", color: "#d0daf0" },
];

function CodeLine({ line, index, isVisible }: { line: typeof codeLines[0]; index: number; isVisible: boolean }) {
  return (
    <motion.div
    ...
    >
      <span className="w-6 text-right text-xs select-none" style={{ color: "#3d4f6b" }}>
        {index + 1}
      </span>
      <pre className="text-sm font-mono leading-relaxed" style={{ color: line.color }}>
        {line.text || " "}
      </pre>
    </motion.div>
  );
...
export function OnePropSection() {
  ...
  useEffect(() => {
    if (isInView) {
      const t = setTimeout(() => setShowWidget(true), codeLines.length * 60 + 800);
  ...
  return (
    <section ref={ref} className="relative py-28 overflow-hidden">
      {/* Orb */}
      <div
        className="orb w-[400px] h-[400px] -right-20 top-1/2 -translate-y-1/2"
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-5xl font-bold mt-4 mb-4" style={{ color: "#f0f4ff" }}>
            One prop.{" "}
            <span style={{ color: "#00e5a0", textShadow: "0 0 30px rgba(0,229,160,0.3)" }}>Done.</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            >
              ...
              <span className="ml-3 text-xs font-mono" style={{ color: "#7a8aaa" }}>
                App.tsx
              </span>
            </div>
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            >
              ...
              <span className="text-sm font-mono px-3 py-1 rounded-full" style={{ color: "#7a8aaa", background: "rgba(255,255,255,0.04)" }}>
                instant result
              </span>
              <div className="h-px flex-1" style={{ background: "rgba(255,255,255,0.1)" }} />
            </motion.div>
            ...
            <motion.div
              ...
              style={{ boxShadow: "0 0 40px rgba(0,229,160,0.1), 0 0 0 1px rgba(0,229,160,0.1)" }}
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <div>
                  <p className="text-xs font-semibold" style={{ color: "#f0f4ff" }}>Assistant</p>
                  <p className="text-[10px]" style={{ color: "#00e5a0" }}>● Online</p>
                </div>
                <motion.span
              ...
              <div className="space-y-2">
                <div
                  ...
                  style={{ background: "rgba(255,255,255,0.05)", color: "#d0daf0", border: "1px solid rgba(255,255,255,0.08)" }}
                >
              ...
              >
                <span className="text-xs flex-1" style={{ color: "#3d4f6b" }}>Ask anything...</span>
                <div
