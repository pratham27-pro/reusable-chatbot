    ...
    <>
      ...
      >
        ...
        <div className="relative text-center mb-14">
          <span
            aria-hidden
            className="pointer-events-none select-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[clamp(72px,16vw,160px)] font-black leading-none text-white/[0.025] blur-[3px] tracking-tight whitespace-nowrap"
            style={{ fontFamily: "Geist, sans-serif" }}
          >
            Play
          </span>
          <div className="relative inline-flex items-center gap-2 mb-4 px-3 py-1.5 rounded-full 
              border border-[#0
            0e5a0]/20 bg-[#00e5a0]/5">
            <Sparkles size={12} className="text-[#00e5a0]" />
            <span className="text-[11px] font-mono text-[#00e5a0]/70 trackin
            g-widest u
          ppercase">
              live configurator
            </span>
          ...
          <div className="mx-auto mb-5 h-px w-24 bg-gradient-to-r from-transparent via-[#00e5a0]/60 to-transparent" />
        ...
        <div className="flex gap-2 flex-wrap justify-center mb-10">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full border text-xs font-medium transition-all duration-150 cursor-pointer border-white/10 bg-white/[0.03] text-gray-600 hover:text-gray-400"
          >
            ↺ Reset
          </button>
        ...
        <div className="relative mt-20">
          <div            <div className="flex-1 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent" />
          ...
          >
            <p className="text-gray-400 text-sm mb-4 leading-relaxed">
              The bot at the bottom right is powered by your RAG server, trained
              on your README and docs.
            </p>
